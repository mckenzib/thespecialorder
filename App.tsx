                    ...
                    <div className="flex-1 flex flex-col md:flex-row gap-4 overflow-hidden">
                        ...
                        <div className="md:w-64 bg-gray-800 p-4 rounded overflow-y-auto text-xs text-gray-300">
                            ...
                            <ul className="space-y-1">
                                ...
                                <li><span className="text-white font-mono">=</span> Cloud Platform (Jump Through)</li>
                                <li><span className="text-gray-400 font-mono">-</span> Moving Platform (Horizontal)</li>
                                <li><span className="text-gray-400 font-mono">|</span> Moving Platform (Vertical)</li>
                                ...
                                <li><span className="text-pink-400 font-mono">D</span> Dumpling Boss (Bouncy)</li>
